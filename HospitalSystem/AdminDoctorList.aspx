...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <h1 class="mb-4 text-center text-dark">Doctor Details</h1>
            <asp:PlaceHolder ID="phDoctorTable" runat="server"></asp:PlaceHolder>
        </div>
        <div class="text-center">
            <asp:Button ID="btnBack" runat="server" Text="Back to Admin Dashboard" CssClass="btn btn-danger btn-back" OnClick="btnBack_Click" />
        </div>
    </form>
