...
namespace HospitalSystem
{
    public partial class AdminPatientManagement : System.Web.UI.Page
    {
        ...
        protected void btnAddPatient_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(name) || string.IsNullOrEmpty(nic) || string.IsNullOrEmpty(birthDate))
            {
                ClientScript.RegisterStartupScript(this.GetType(), "alert", "showErrorAlert('Please fill all required fields.');", true);
                return;
            }
